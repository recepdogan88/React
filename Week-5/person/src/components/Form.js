  ...
  return (
    <div className='col-3 mt-5 ms-5 me-5'>
        ...
        <form className='mt-4'onSubmit={postData}>
            <div class="mb-3">
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='Firstname'onChange={(e)=>setname(e.target.value)}/>
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"placeholder='Lastname'onChange={(e)=>setlastname(e.target.value)}/>
            </div>
            <div class="mb-3">
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"placeholder='Email'onChange={(e)=>setemail(e.target.value)}></input>
            </div>
            <div class="mb-3">
