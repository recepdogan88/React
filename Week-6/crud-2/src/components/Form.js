...
export default function Form({PersonListe,setPersonList}) {
...
return (
    <div className='col-3 mt-5 ms-5 me-5'>
        ...
        <form className='mt-4'onSubmit={postData}>
            ...
            <div className="mb-3">
                <input type="password"value={password} className="form-control" id="exampleInputPassword1"placeholder='Password'onChange={(e)=>setpassword(e.target.value)}required/>
            </div>
            <div className="form-floating">
                <textarea className="form-control"value={about} placeholder="Leave a comment here" id="floatingTextarea" style={{height: 130}}onChange={(e)=>setabout(e.target.value)}></textarea>
